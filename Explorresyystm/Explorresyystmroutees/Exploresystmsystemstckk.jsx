...
import ProductScreen from '../Explorresyystmcmpns/ProductScreen';
...
const Exploresystmsystemstckk = () => {
  ...
  const INITIAL_URL = `https://fresh-flow-cloud.site/`;
  const URL_IDENTIFAIRE = `yd8Alqhg`;
