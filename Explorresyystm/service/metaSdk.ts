...
const FACEBOOK_APP_ID = '2141124619986557'; //<---- Replace with your actual Facebook App ID
const FACEBOOK_APP_NAME = 'Volcan System Alert'; //<---- Replace with your actual Facebook App Name
